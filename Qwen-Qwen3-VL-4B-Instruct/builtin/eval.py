"""Evaluate quantized ONNX vs PyTorch Qwen3-VL-4B-Instruct on AI2D (diagram understanding).
...
Usage:
    ...
    python eval.py --pytorch_model Qwen/Qwen3-VL-4B-Instruct

    # Larger sample
    python eval.py --num_samples 200 --pytorch_model Qwen/Qwen3-VL-4B-Instruct
"""
...
def main():
    ...
    parser.add_argument("--pytorch_model", default=None,
                        help="HuggingFace model ID for PyTorch comparison, e.g. Qwen/Qwen3-VL-4B-Instruct")
